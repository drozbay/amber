...
%
% DEPENDENCIES:
% nanconv.m for performing Gaussian window filtering
% nanconv.m is copyright (c) 2013, Benjamin Kraus
% $Id: nanconv.m 4861 2013-05-27 03:16:22Z bkraus $
%
% INPUTS:
% valIn -   NxM matrix of core values for series with N cores and M frames
% tSeries - Boolean value defining whether or not to interpret the input as
%           a time series or not. If tSeries==1, a Savitsky-Golay filter 
%           will be used. Otherwise, a Gaussian window will be used.
